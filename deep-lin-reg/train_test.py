...
def trainAndTest(X_train, Y_train, X_test, Y_test, hid_dim, p, n, learning_rate = 0.0001, nepochs = 100):
	#print("Data dim: %d" % p)
	...
	test_mse = model.evaluate(X_test, Y_test, batch_size = n, verbose = 1)
